# Kotlin-Learning
Task descriptions are given below
...
Run TestNiceString to check 3our solution.
...
N.B. above tasks are taken from Kotlin for Java Developers course of coursera
